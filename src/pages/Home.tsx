    ...
    <>
        ...
        <div className="container mx-auto px-4">
          ...
          <Reveal>
            <div className="relative overflow-hidden rounded-2xl bg-card border border-primary/20 p-4 sm:p-6 md:p-12 group hover:border-primary/50 transition-colors duration-500">
              ...
              <div className="relative z-10">
                <h3 className="text-lg sm:text-xl md:text-3xl font-bold mb-2 sm:mb-3 md:mb-4 bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">
                ...
                <div className="flex flex-wrap gap-2 sm:gap-3 md:gap-4">
                  {learningSkills.map((tech, i) => (
                    <motion.span
                      key={tech}
                      className="relative px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs md:text-sm font-medium overflow-hidden group/tag border border-primary/20 bg-background/50 hover:border-primary/50 transition-colors"
                      initial={{ opacity: 0, scale: 0.8 }}
                      whileInView={{ opacity: 1, scale: 1 }}
                      transition={{ delay: i * 0.1 }}
                      viewport={{ once: true }}
                    >
                      <span className="relative z-10 bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">{tech}</span>
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <Reveal>
            <h2 className="text-3xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary via-accent to-primary animate-gradient bg-size-200">
              Let's Work Together
            </h2>
          </Reveal>
          <Reveal>
          ...
          <Reveal>
            <div className="relative inline-block group">
              ...
              <Button
                ...
                size="lg"
                className="relative bg-background text-foreground border border-primary/20 hover:bg-primary/10 hover:border-primary/50 text-base md:text-lg px-8 py-6 h-auto"
              >
